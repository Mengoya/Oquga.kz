                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[600px]">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-base leading-relaxed flex-grow">
                            Здесь представлены учреждения высшего образования
                            Казахстана. Изучите рейтинги, специализации и
                            возможности каждого университета в едином реестре.
                        </p>
                    ...
                    <section className="lg:col-span-6 relative group h-[400px] lg:h-full overflow-hidden rounded-2xl border shadow-sm">
                        <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105">
                            <Image
                                ...
                                alt="Студенты в кампусе университета"
                                fill
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-8 md:p-10 flex flex-col items-start gap-4">
                            ...
                            <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
                                Министерство науки объявило новые правила
                                распределения грантов на 2025 год
                            </h1>
                            <p className="text-gray-200 text-lg md:text-xl line-clamp-2 max-w-2xl">
                                Узнайте об изменениях в проходных баллах ЕНТ и
                                новых квотах.
                            </p>
                            <Button
                                size="lg"
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-sm mb-6">
                            Пошаговые инструкции для абитуриентов всех уровней
                            образования:
                        </p>
