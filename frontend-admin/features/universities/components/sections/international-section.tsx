...
import {
    ...
    InternationalSectionDto,
    InternationalItemDto,
} from '../../types';
import {
    Plus,
    Trash2,
...
export function InternationalSection({ data, onChange }: Props) {
    const t = useTranslations('UniversityEdit.international');
    ...
    const removeSection = (index: number) => {
        onChange({
            internationalSections: sections.filter((_, i) => i !== index),
        });
    };

    const updateSection = (
        index: number,
        updates: Partial<InternationalSectionDto>,
    ) => {
        onChange({
            internationalSections: sections.map((s, i) =>
                i === index ? { ...s, ...updates } : s,
            ),
        });
    };
    ...
    const updateItem = (
        sectionIndex: number,
        itemIndex: number,
        updates: Partial<InternationalItemDto>,
    ) => {
        const section = sections[sectionIndex];
        updateSection(sectionIndex, {
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-end gap-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            />
                                            <Label
                                                htmlFor={`active-section-${sectionIndex}`}
                                            >
                                                {t('isActive')}
                                            </Label>
                                        </div>
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        ...
                                                        <div className="flex items-end gap-4">
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                />
                                                                <Label
                                                                    htmlFor={`active-item-${sectionIndex}-${itemIndex}`}
                                                                    className="text-xs"
                                                                >
                                                                    {t(
                                                                        'itemActive',
